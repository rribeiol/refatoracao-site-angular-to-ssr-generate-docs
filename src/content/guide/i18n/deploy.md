...
<docs-code header="angular.json" path="src/content/examples/i18n/angular.json" visibleRegion="i18n-baseHref"/>
...
<docs-code path="src/content/examples/i18n/doc-files/nginx.conf" language="nginx"/>

### Apache example

The following example displays an Apache configuration.

<docs-code path="src/content/examples/i18n/doc-files/apache2.conf" language="apache"/>
