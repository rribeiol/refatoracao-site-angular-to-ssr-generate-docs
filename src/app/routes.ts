...
import { contentResolver } from '../dev-infra-docs/providers';
import { mapNavigationItemsToRoutes, flatNavigationData } from '../dev-infra-docs/utils';
...
//   },
// );
export const TUTORIALS_ROUTES = [...docsTutorialsRoutes];
