...
1. The provided sample application creates the `Actor` class which defines the data model reflected in the form.
    ...
    <docs-code header="src/app/actor.ts" language="typescript" path="src/content/examples/forms/src/app/actor.ts"/>

1. The form layout and details are defined in the `ActorFormComponent` class.

    <docs-code header="src/app/actor-form/actor-form.component.ts (v1)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.ts" visibleRegion="v1"/>
...
1. The following code creates a new actor instance, so that the initial form can show an example actor.
    ...
    <docs-code language="typescript" path="src/content/examples/forms/src/app/actor-form/actor-form.component.ts" language="typescript" visibleRegion="Marilyn"/>
...
1. The application enables the Forms feature and registers the created form component.
    ...
    <docs-code header="src/app/app.module.ts" language="typescript" path="src/content/examples/forms/src/app/app.module.ts"/>

1. The form is displayed in the application layout defined by the root component's template.

    <docs-code header="src/app/app.component.html" language="html" path="src/content/examples/forms/src/app/app.component.html"/>
...
1. The sample form uses some style classes from [Twitter Bootstrap](https://getbootstrap.com/css): `container`, `form-group`, `form-control`, and `btn`.
    ...
    <docs-code header="src/styles.css" path="src/content/examples/forms/src/styles.1.css"/>
...
1. The form requires that an actor's skill is chosen from a predefined list of `skills` maintained internally in `ActorFormComponent`.
    ...
    <docs-code header="src/app/actor-form/actor-form.component.html (skills)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.html" visibleRegion="skills"/>
...
<docs-code header="src/app/actor-form/actor-form.component.html (excerpt)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.html" visibleRegion="ngModelName-1"/>
...
1. Update the `<form>` tag with a template reference variable, `#actorForm`, and set its value as follows.
    ...
    <docs-code header="src/app/actor-form/actor-form.component.html (excerpt)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.html" visibleRegion="template-variable"/>
...
<docs-code header="src/app/actor-form/actor-form.component.html (excerpt)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.html" visibleRegion="ngModel-2"/>
...
<docs-code header="src/assets/forms.css" language="css" path="src/content/examples/forms/src/assets/forms.css"/>

1. In the `index.html` file, update the `<head>` tag to include the new style sheet.

<docs-code header="src/index.html (styles)" path="src/content/examples/forms/src/index.html" visibleRegion="styles"/>
...
<docs-code header="src/app/actor-form/actor-form.component.html (hidden-error-msg)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.html" visibleRegion="hidden-error-msg"/>
...
<docs-code header="src/app/actor-form/actor-form.component.html (excerpt)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.html" visibleRegion="name-with-error-msg"/>
</docs-step>
</docs-workflow>
...
1. In the component file, add the actor-creation method to the actor data model.
    ...
    <docs-code header="src/app/actor-form/actor-form.component.ts (New Actor method)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.ts" visibleRegion="new-actor"/>

1. Bind the button's click event to an actor-creation method, `newActor()`.

    <docs-code header="src/app/actor-form/actor-form.component.html (New Actor button)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.html" visibleRegion="new-actor-button-no-reset"/>
...
1. To restore the pristine state of the form controls, clear all of the flags imperatively by calling the form's `reset()` method after calling the `newActor()` method.
    ...
    <docs-code header="src/app/actor-form/actor-form.component.html (Reset the form)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.html" visibleRegion="new-actor-button-form-reset"/>
...
<docs-code header="src/app/actor-form/actor-form.component.html (ngSubmit)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.html" visibleRegion="ngSubmit"/>
</docs-step>
...
<docs-code header="src/app/actor-form/actor-form.component.html (submit-button)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.html" visibleRegion="submit-button"/>
</docs-step>
...
<docs-code header="src/app/actor-form/actor-form.component.html (excerpt)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.html" visibleRegion="edit-div"/>
...
<docs-code header="src/app/actor-form/actor-form.component.ts (submitted)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.ts" visibleRegion="submitted"/>
...
<docs-code header="src/app/actor-form/actor-form.component.html (excerpt)" path="src/content/examples/forms/src/app/actor-form/actor-form.component.html" visibleRegion="submitted"/>
...
<docs-code-multifile>
    <docs-code header="actor-form/actor-form.component.ts" path="src/content/examples/forms/src/app/actor-form/actor-form.component.ts" visibleRegion="final"/>
    <docs-code header="actor-form/actor-form.component.html" path="src/content/examples/forms/src/app/actor-form/actor-form.component.html" visibleRegion="final"/>
    <docs-code header="actor.ts" path="src/content/examples/forms/src/app/actor.ts"/>
    <docs-code header="app.module.ts" path="src/content/examples/forms/src/app/app.module.ts"/>
    <docs-code header="app.component.html" path="src/content/examples/forms/src/app/app.component.html"/>
    <docs-code header="app.component.ts" path="src/content/examples/forms/src/app/app.component.ts"/>
    <docs-code header="main.ts" path="src/content/examples/forms/src/main.ts"/>
    <docs-code header="forms.css" path="src/content/examples/forms/src/assets/forms.css"/>
</docs-code-multifile>
