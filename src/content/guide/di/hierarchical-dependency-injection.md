...
<docs-code header="src/app/self/self.component.ts" path="src/content/examples/resolution-modifiers/src/app/self/self.component.ts" visibleRegion="self-component"/>
