...
import { NavigationList, IconComponent } from '../../../../dev-infra-docs/components';
import { ClickOutside } from '../../../../dev-infra-docs/directives';
import { IS_SEARCH_DIALOG_OPEN, WINDOW } from '../../../../dev-infra-docs/providers';
import { NavigationState } from '../../../../dev-infra-docs/services';
import { isApple, getBaseUrlAfterRedirects } from '../../../../dev-infra-docs/utils';
