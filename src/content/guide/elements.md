...
<docs-code-multifile>
    <docs-code header="popup.component.ts" path="src/content/examples/elements/src/app/popup.component.ts"/>
    <docs-code header="popup.service.ts" path="src/content/examples/elements/src/app/popup.service.ts"/>
    <docs-code header="app.component.ts" path="src/content/examples/elements/src/app/app.component.ts"/>
</docs-code-multifile>
