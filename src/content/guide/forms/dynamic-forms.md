...
<docs-code-multifile>
    <docs-code header="dynamic-form.component.ts" path="src/content/examples/dynamic-form/src/app/dynamic-form.component.ts"/>
    <docs-code header="dynamic-form-question.component.ts" path="src/content/examples/dynamic-form/src/app/dynamic-form-question.component.ts"/>
</docs-code-multifile>
...
<docs-code header="src/app/question-base.ts" path="src/content/examples/dynamic-form/src/app/question-base.ts"/>
...
<docs-code header="question-textbox.ts" path="src/content/examples/dynamic-form/src/app/question-textbox.ts"/>

The `DropdownQuestion` control type presents a list of choices in a select box.

 <docs-code header="question-dropdown.ts" path="src/content/examples/dynamic-form/src/app/question-dropdown.ts"/>
...
<docs-code header="src/app/question-control.service.ts" path="src/content/examples/dynamic-form/src/app/question-control.service.ts"/>
...
<docs-code-multifile>
  <docs-code header="dynamic-form-question.component.html" path="src/content/examples/dynamic-form/src/app/dynamic-form-question.component.html"/>
  <docs-code header="dynamic-form-question.component.ts" path="src/content/examples/dynamic-form/src/app/dynamic-form-question.component.ts"/>
</docs-code-multifile>
...
<docs-code header="src/app/question.service.ts" path="src/content/examples/dynamic-form/src/app/question.service.ts"/>
...
<docs-code-multifile>
    <docs-code header="dynamic-form.component.html" path="src/content/examples/dynamic-form/src/app/dynamic-form.component.html"/>
    <docs-code header="dynamic-form.component.ts" path="src/content/examples/dynamic-form/src/app/dynamic-form.component.ts"/>
</docs-code-multifile>
...
<docs-code header="app.component.ts" path="src/content/examples/dynamic-form/src/app/app.component.ts"/>
