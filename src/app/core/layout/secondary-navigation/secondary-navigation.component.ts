...
import { NavigationList } from '../../../../dev-infra-docs/components';
import { ClickOutside } from '../../../../dev-infra-docs/directives';
import { NavigationItem } from '../../../../dev-infra-docs/interfaces';
import { WINDOW } from '../../../../dev-infra-docs/providers';
import { NavigationState } from '../../../../dev-infra-docs/services';
import { getNavigationItemsTree, markExternalLinks, findNavigationItem, getBaseUrlAfterRedirects, shouldReduceMotion } from '../../../../dev-infra-docs/utils';
