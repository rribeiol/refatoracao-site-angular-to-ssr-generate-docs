<docs-decorative-header title="Forms in Angular" imgSrc="src/assets/images/overview.svg"> <!-- markdownlint-disable-line -->
...
<docs-code path="src/content/examples/forms-overview/src/app/reactive/favorite-color/favorite-color.component.ts"/>
...
<docs-code path="src/content/examples/forms-overview/src/app/template/favorite-color/favorite-color.component.ts"/>
...
<docs-code header="Favorite color test - view to model" path="src/content/examples/forms-overview/src/app/reactive/favorite-color/favorite-color.component.spec.ts" visibleRegion="view-to-model"/>
...
<docs-code header="Favorite color test - model to view" path="src/content/examples/forms-overview/src/app/reactive/favorite-color/favorite-color.component.spec.ts" visibleRegion="model-to-view"/>
...
<docs-code header="Favorite color test - view to model" path="src/content/examples/forms-overview/src/app/template/favorite-color/favorite-color.component.spec.ts" visibleRegion="view-to-model"/>
...
<docs-code header="Favorite color test - model to view" path="src/content/examples/forms-overview/src/app/template/favorite-color/favorite-color.component.spec.ts" visibleRegion="model-to-view"/>
